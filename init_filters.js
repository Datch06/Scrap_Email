...
$(document).ready(function () {
  ...
  $mostUsedTab.on('shown.bs.tab', function (event) {
    ...
    $("#otherFunction-mostused").append($("#otherFunction-rules").contents());
  ...
  $mostUsedTab.on('hide.bs.tab', function (event) {
    ...
    $("#otherFunction-rules").append($("#otherFunction-mostused").contents());
...
function initTouchSpin() {
  $("input[type='number']:not(.noTouchSpin)").TouchSpin({
